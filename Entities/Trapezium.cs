...
namespace CSharpHomeCase6_1.Entities
{
    class Trapezium : Figure
    {
        ...
        protected virtual void ValidatePoints()
        {
            ...
            if (flag == false)
            {
                throw new MyExceptions.NotParallelSidesException("It is not a Trapeze!!! There is no parallel sides.\n\n");
            }

            if (Basis1 == 0 || Basis2 == 0 || Side1 == 0 || Side2 == 0)
            {
                throw new MyExceptions.PointCoincidenceException("It is not a Trapeze!!! There is a Point Coincidence.\n\n");
            }
        }
